  ...
  <div class="post-container">
      <div v-if="this.page" class="post-card">
        ...
        <div v-if="this.page" class="page-detail">
          <router-link v-if="this.page.regularPath" :to="this.page.regularPath">
          <div v-if="this.page" class="page-title">{{ this.title }}</div>
          <div v-if="this.subtitle" class="page-subtitle">{{ this.subtitle }}</div>
          </router-link>
          <div v-if="this.description" class="page-description">{{ this.description }}</div>
